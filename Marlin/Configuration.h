...
#define STRING_CONFIG_H_AUTHOR "(LuukvH, SKR-mini-E3-V3.0)" // Who made the changes.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 110.76
  #define DEFAULT_bedKi  21.98
  #define DEFAULT_bedKd 362.14
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 93 } //TODO ESteps
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -10, -1.85 } // TODO Probe Z-Offset
